...
- [`c925159`](https://github.com/cevr/skills/commit/c925159660ad0ea2ace69a843bf88bb1f2d541cc) Thanks [@cevr](https://github.com/cevr)! - Distinguish managed vs unmanaged skills in list, auto-remove stale local skills during update, support local path removal, and align project tooling with scaffolding spec
...
- [`26a0b95`](https://github.com/cevr/skills/commit/26a0b95486226c46e70615fd30a7f862b982f05f) Thanks [@cevr](https://github.com/cevr)! - fix: discover skills at repo root level, not just under skills/ or skill/ prefixes
